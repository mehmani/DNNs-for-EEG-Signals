![alt text](http://url/to/img.png)<img src="https://github.com/favicon.ico" width="48">![alt text](screenshots/filename.png "Description goes here")# Bidirectional Recurrent Convolutional Networks for Disentangling Brain Activity from EEG Data
